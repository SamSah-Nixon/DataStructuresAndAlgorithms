public class CheckMyCodeUL3{
	...
	private static double totalTest = 78.0;
	...
	public static void main(String args[]){
    	...
    	System.out.println("----------------------");
    	System.out.println("Popping last front element: ");
    	testFunction((""+myList.popRear()), "17");
    	System.out.println("Popping last front element: ");
    	testFunction((""+myList.popRear()), "50");
    	System.out.println("Popping last front element: ");
    	testFunction((""+myList.popRear()), "12");
    	System.out.println("Testing toString:\t");
    	testFunction((""+myList.toString()), "[4, 1, 4, 28]");
    	System.out.println("Testing Size:\t");
    	...
    	testFunction((""+myList.reverseToString()), "[28, 4, 1, 4, 3]");
    	System.out.println("Testing toString:\t");
    	testFunction((""+myList.toString()), "[3, 4, 1, 4, 28]");
    	System.out.println("Testing Size:\t");
		testFunction((""+myList.size()), "5");
    	...
    	System.out.println("----------------------");
    	System.out.println("Popping element at pos 3: ");
    	testFunction((""+myList.pop(3)), "4");
    	System.out.println("Popping element at pos 5: ");
    	testFunction((""+myList.pop(5)), "null");
    	System.out.println("Popping element at pos 1: ");
    	testFunction((""+myList.pop(1)), "4");
    	System.out.println("Testing toString:\t");
    	testFunction((""+myList.toString()), "[3, 1, 28]");
    	System.out.println("Testing Size:\t");
		testFunction((""+myList.size()), "3");
